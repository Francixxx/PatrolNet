...
function IncidentReport() {
  ...
  const fetchAvailableTanods = () => {
    ...
    fetch("http://192.168.100.3:3001/api/logs")
      .then(res => res.json())
      .then(data => {
  ...
  const handleAssignTanod = () => {
    ...
    fetch(`http://192.168.100.3:3001/api/incidents/${selectedIncident.id}/status`, {
      method: 'PUT',
      headers: {
  ...
  const handleMarkAsResolved = () => {
    ...
    fetch(`http://192.168.100.3:3001/api/incidents/${selectedIncident.id}/resolve`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const handleDeleteIncident = () => {
    ...
    fetch(`http://192.168.100.3:3001/api/incidents/${selectedIncident.id}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
                  ...
                  <tr key={item.id}>
                    ...
                    <td className="incident-cell">
                      <div className="incident-icon">
                        <img
                          src={`http://192.168.100.3:3001/uploads/${item.image}`}
                          alt="Incident"
              ...
              <div className="modal-body">
                ...
                <div className="modal-field">
                  ...
                  <div className="modal-image-container">
                    <img 
                      src={`http://192.168.100.3:3001/uploads/${selectedIncident.image}`} 
                      alt="Incident" 
