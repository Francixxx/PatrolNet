...
function Accounts() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('http://192.168.100.3:3001/api/users');
  ...
  const handleAddAccount = async (e) => {
    ...
    try {
      const response = await fetch('http://192.168.100.3:3001/register', {
        method: 'POST',
        headers: {
...
const handleEditAccount = async (e) => {
  ...
  try {
    const response = await fetch(`http://192.168.100.3:3001/api/users/${editAccount.id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  try {
    const response = await fetch(`http://192.168.100.3:3001/api/users/${accountId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      }
